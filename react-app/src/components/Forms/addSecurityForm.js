...
export default function Addsecurity() {
    ...
    const values = { isin, cusip, issuer, maturitydate, coupon, type, facevalue, status };
    ...
    return (
        ...
        <form onSubmit={addsecurity} className={classes.root} noValidate>
            <div>
